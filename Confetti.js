	...
	$('.pb').each(function(){
		...
		var dataperc = t.attr('data-perc'),
				barperc = Math.round(dataperc*5.56/2);
		t.find('.bar').animate({width:barperc}, dataperc*0);
...
$(function() {
	...
	$('.pb').each(function(){
		...
		var dataperc = t.attr('data-perc'),
				barperc = Math.round(dataperc*5.56/2);
				leftamount = (100 - barperc) +204;
		t.find('.barneg').animate({width:barperc, left: leftamount}, dataperc*0);
		t.find('.label').append('<div class="perc"></div>');
